...
public class DiagnosticParameters {
    ...
    public Map<String, Object> toMap() {
        ...
        parameters.put("skipTestCloudStorage", Optional.ofNullable(skipTestCLoudStorage).orElse(false));
    ...
    public static class DiagnosticParametersBuilder {
        ...
        public DiagnosticParametersBuilder withSkipTestCloudStorage(Boolean skipTestCloudStorage) {
            diagnosticParameters.setSkipTestCLoudStorage(skipTestCloudStorage);
            return this;
        }
