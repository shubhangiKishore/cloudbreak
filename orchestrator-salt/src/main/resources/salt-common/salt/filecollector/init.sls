...
/opt/cdp-telemetry/conf/bundle_info.json:
   file.managed:
    ...
    - mode: '0750'
    - failhard: True
{% if not filecollector.skipTestCloudStorage and filecollector.destination == "CLOUD_STORAGE" %}
...
{% elif filecollector.destination == "ENG" and fluent.dbusClusterLogsCollection and databus.endpoint %}
