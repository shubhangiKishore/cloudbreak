...
{% set skip_test_cloud_storage = False %}
{% if salt['pillar.get']('filecollector:skipTestCloudStorage') %}
    {% set skip_test_cloud_storage = True %}
{% endif %}
...
{% do filecollector.update({
    ...
    "skipTestCloudStorage": skip_test_cloud_storage,
